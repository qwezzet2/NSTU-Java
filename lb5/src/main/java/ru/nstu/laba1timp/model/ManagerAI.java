...
public class ManagerAI extends BaseAI {
    ...
    // private static final double SPEED = 3; // Не используется, но можно оставить для информации
    ...
    protected void updateObjectPosition(Person obj, Random rand) {
        ...
        if (man.circleCenterX == 0 && man.circleCenterY == 0) {
            ...
            // Опционально: логирование для отладки инициализации
        ...
        // Нормализация угла (чтобы он оставался в пределах 0 до 2*PI) - не обязательно, но чисто
